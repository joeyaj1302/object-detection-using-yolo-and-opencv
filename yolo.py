...
print("The {} classes/objects in the coco dataset that our model can classify are :".format(len(LABELS)))
...
indexs = cv2.dnn.NMSBoxes(boxes,confidences,args['confidence'],args['threshold']) #Non max supression 
